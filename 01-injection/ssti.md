...
| **SSRF via Template** | Template engine fetches remote resources or accesses internal APIs | §4-1 (FreeMarker `getResourceAsStream`), §1-3 | Internal service access, cloud metadata |
